...
export const FIREFLY_AXIOS_INSTANCE = Axios.create();
FIREFLY_AXIOS_INSTANCE.defaults.baseURL = 'https://firefly-api.adobe.io';

// add a second `options` argument here if you want to pass extra options to each generated query
export const customFireflyAxiosInstance = <T>(
  ...
  const promise = FIREFLY_AXIOS_INSTANCE({
    ...config,
    ...options,
