...
export interface GenerateSimilarImagesRequestV3 {
  /** Firefly will create similar variations. Use a URL or an <code>uploadID</code> as the source for the image. Firefly only allows these listed domains for input URLs in the request: <ul> <li><code>amazonaws.com</code></li> <li><code>windows.net</code></li> <li><code>dropboxusercontent.com</code></li> <li><code>storage.googleapis.com</code></li> </ul> */
  image: BaseInputImageV3;
  /**
   * The number of variations to generate. `numVariations` defaults to the number of seed images, or to 1 if you do not specify seeds.
   * @minimum 1
   * @maximum 4
   */
  numVariations?: number;
  /**
   * An array of seed image IDs. These reference images help ensure consistent image generation across multiple API calls. For example, use the same seed to generate a similar image in different styles. If specified along with `numVariations`, the number of seeds provided must equal `numVariations`.
   * @minItems 1
   * @maxItems 4
   */
  seeds?: number[];
  /** The desired width and height for the final image, in pixels. Supported sizes for the output images are: <ul> <li>Square (1:1) - width 2048px, height 2048px </li> <li>Square (1:1) - width 1024px, height 1024px </li> <li>Landscape (4:3)  - width 2304px, height 1792px </li> <li>Portrait (3:4)  - width 1792px, height 2304px</li> <li>Widescreen (16:9) - width 2688px, height 1536px </li> <li>Widescreen (16:9) - width 1344px, height 756px </li> <li>Widescreen (16:9) - width 2688px, height 1512px </li> <li>(7:4)  - width 1344px, height 768px </li> <li>(9:7) - width 1152px, height 896px </li> <li>(7:9) - width 896px, height 1152px</li> </ul> */
  size?: Size;
}
