...
export interface GenerateObjectCompositeRequestV3 {
  contentClass?: ContentClassV3;
  /** The image to expand. You can either use a url or an <code>uploadID</code> as the source for the image. Firefly only allows these listed domains as input URL in the request: <ul> <li><code>amazonaws.com</code></li> <li><code>windows.net</code></li> <li><code>dropboxusercontent.com</code></li> </ul> */
  image: InputImageV3;
  /** Required. Selected areas of a background image that Firefly uses to fill the source image. */
...
export interface GenerateSimilarImagesRequestV3 {
  /** Firefly will create similar variations. You can either use a url or an <code>uploadID</code> as the source for the image. Firefly only allows these listed domains as input URL in the request: <ul> <li><code>amazonaws.com</code></li> <li><code>windows.net</code></li> <li><code>dropboxusercontent.com</code></li> </ul> */
...
export interface PublicBinaryInputV3 {
  ...
  uploadId?: string;
  /**
   * Presigned URL of an uploaded file. You can either use a url or an <code>uploadID</code> as the source for the image. Firefly only allows these listed domains as input URL in the request: <ul> <li><code>amazonaws.com</code></li> <li><code>windows.net</code></li> <li><code>dropboxusercontent.com</code></li> </ul>
   * @minLength 1
   * @maxLength 2083
   */
  url?: string;
