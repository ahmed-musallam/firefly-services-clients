...
export interface GenerateImagesRequestV3 {
  ...
  /**
   * A negative prompt of things Firefly will try to avoid generating in the image.
   * @maxLength 1024
   */
  negativePrompt?: string;
  /**
...
If specified alongside with <code>numVariations</code>, the number of seeds must equal to <code>numVariations</code>.
   * @minItems 1
   * @maxItems 4
   */
  seeds?: number[];
