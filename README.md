...
| **[@musallam/audio-video-client](./packages/audio-video-client)**                             | Adobe Audio and Video API client             | `@musallam/audio-video-client`               |
...
| ~~**[@musallam/dynamic-graphics-render-client](./packages/dynamic-graphics-render-client)**~~ | ⚠️ **Deprecated** - Use `audio-video-client` | `@musallam/dynamic-graphics-render-client`   |
...
# For Audio and Video API
npm install @musallam/audio-video-client @musallam/ims-client

# For Storage and Collaboration API
npm install @musallam/storage-and-collaboration-client @musallam/ims-client

# For all
npm install @musallam/firefly-client @musallam/photoshop-client @musallam/lightroom-client @musallam/audio-video-client @musallam/storage-and-collaboration-client @musallam/ims-client
```
...
#### Audio and Video API Example

```typescript
import { AudioVideoClient, pollAudioVideoJob, IMSClient } from '@musallam/audio-video-client';
...
// Render a dynamic graphics template
...
│   │   └── vite.config.ts
│   │
│   ├── audio-video-client/                 # Audio and Video API client
│   ├── dynamic-graphics-render-client/     # Dynamic Graphics (DEPRECATED)
│   │   ├── src/
│   │   │   ├── generated/                   # Auto-generated from OpenAPI specs
│   │   │   ├── mutator/                     # Axios instance customization
│   │   │   ├── extension/                   # Job polling utilities
...
- [Audio and Video Client Documentation](./packages/audio-video-client/README.md)
- [Dynamic Graphics Render Client Documentation](./packages/dynamic-graphics-render-client/README.md) ⚠️ Deprecated
...
AUDIO_VIDEO_AXIOS_INSTANCE.defaults.baseURL = 'https://custom-audio-video-proxy.example.com';
...
If you're using `@musallam/dynamic-graphics-render-client`, you should migrate to `@musallam/audio-video-client`:
...
The API is identical, just update the package name and imports.

## 🎯 Roadmap

- [x] Adobe Cloud Storage and Collaboration API client
- [x] Adobe Lightroom API client
- [x] Adobe Audio and Video API client
